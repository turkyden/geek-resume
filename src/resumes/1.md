...
<img
  class="rounded-full pl-0 ml-2 w-36 h-36 float-right"
...
<div class="inline-block mb-4 text-xl transition-all font-bold bg-clip-text text-transparent bg-gradient-to-r from-red-400 to-yellow-500 border-0 border-b border-dotted border-red-500">
  教育背景
</div>
...
<div class="inline-block mb-4 text-xl transition-all font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-green-500 border-0 border-b border-dotted border-red-500">
  工作履历
</div>
