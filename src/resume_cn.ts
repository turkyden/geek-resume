...
**<code>2018.07 ~ 2021.07</code>** 同济大学 / 设计硕士 / 非全日制

主修中外设计史，平面设计，应用交互设计，在职学习中

**<code>2013.09 ~ 2017.07</code>** 上海第二工业大学 / 电子商务应用技术 / 工学学士 / 全日制
...
任职期间主要负责：OA 协同办公软件产品研发，企业级中后台低代码物料中心的建设。

**ECode 无侵入二次开发框架**

为了解决 SaaS 产品交付实施成本过高与客户难以定制化的问题，我提出使用 React.forward 组件代理的方式改造标准 UI 组件，并编写 MiddleWare SDK，赋能 SaaS 标准产品的无侵入二次开发，为后续的可视化编辑的落地打下基础。作为核心成员，我还负责该框架在企业内部的推广和技术培训，最终根据交付实施部门统计，定制化二次开发的成本下降了 40% 左右。

**EDesign 低代码开发平台**

是我参与的复杂度较高的项目之一，Low Code Platform 是今年公司主推的 SaaS 产品新特性，目的是使得软件产品交付使用之后，客户可以根据实际的需求搭建和修改前端页面，通过牺牲代码的灵活性来换取垂直业务领域的研发效能提升。我主要负责自定义 React Hooks 的开发与可视化配置面板 UI 组件的设计。（React + Mobx + Typescript + Webpack）

**<code>2017.07 ~ 2018.09</code>** 联和金融集团有限公司 / 开发工程师

任职期间主要负责 Hey UI 组件库的开发与文档维护工作，因为在初级版本的 AntD v1.0 中无法实现黑夜模式，而且一些特殊的 UI 组件无法支撑 CNABS 资产证券化中后台业务的 UI 设计需求，我基于 Stroybook 重新封装 rc-components 实现了一套平行于 AntD 的企业级组件库。不仅满足了团队业务开发的需要，而且还使得公司的设计资产能够以技术的方式沉淀下来。
